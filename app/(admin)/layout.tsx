...
const baseLinks=[["/admin","Dashboard",LayoutDashboard],["/admin/products","Products",Package],["/admin/categories","Categories",FolderTree],["/admin/orders","Orders",ClipboardList],["/admin/users","Customers",Users],["/admin/analytics","Insights",BarChart3],["/admin/settings","Settings",Settings]] as const;
...
export default async function AdminLayout({children}:{children:React.ReactNode}){
 ...
 const links=p?.role==="ADMIN"?([["/admin","Dashboard",LayoutDashboard],["/admin/products","Products",Package],["/admin/jumia","Jumia Store",ShoppingCart],["/admin/categories","Categories",FolderTree],["/admin/orders","Orders",ClipboardList],["/admin/users","Customers",Users],["/admin/analytics","Insights",BarChart3],["/admin/settings","Settings",Settings]] as const):baseLinks;
